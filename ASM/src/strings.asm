...
;-----[A]---------------------------------------------------------------------------------------------------------------
alive_bees_string							byte				'Alive bees: ', 0
...
;-----[D]---------------------------------------------------------------------------------------------------------------
dead_bees_string							byte				'Dead bees: ', 0
death_timer_string							byte				'Death timer: ', 0
;-----[E]---------------------------------------------------------------------------------------------------------------
...
fps_str									byte				'FPS: ',0										;
frame_count_30_seconds_str						byte		'Total frame count after 30 seconds: ', 0
;-----[G]---------------------------------------------------------------------------------------------------------------
