...
max_number_of_bees  							equ 				15000 ;Per team
												...
												align   			16
global team1BeeMovementArray, team2BeeMovementArray, beeTransformDataArray, cbPerInst, team1BeeTargetsArray, team2BeeTargetsArray, team1BeeSizesArray, team2BeeSizesArray
