...
team2InstanceBufferData							label				d3d11_subresource_data							; Declare structure label
												;-----------------------------------------------------------------------
												qword				beeTransformDataArray							; pSysMem
												dword				?												; SysMemPitch
												dword				?												; SysMemSlicePitch
												;-----------------------------------------------------------------------
team2InstanceBufferDataE						label				byte												; End marker
												align				16
...
vertexBufferDataBlueBee							label				d3d11_subresource_data							; Declare structure label
												;-----------------------------------------------------------------------
												qword				blueBee												; pSysMem
												dword				?												; SysMemPitch
												dword				?												; SysMemSlicePitch
												;-----------------------------------------------------------------------
vertexBufferDataBlueBeeE						label				byte												; End marker

vertexBufferDescBlueBee							label				d3d11_buffer_desc								; Declare structure label
												;-----------------------------------------------------------------------
...
vertexBufferDataYellowBee						label				d3d11_subresource_data							; Declare structure label
												;-----------------------------------------------------------------------
												qword				yellowBee												; pSysMem
												dword				?												; SysMemPitch
												dword				?												; SysMemSlicePitch
												;-----------------------------------------------------------------------
vertexBufferDataYellowBeeE						label				byte												; End marker

vertexBufferDescYellowBee						label				d3d11_buffer_desc								; Declare structure label
												;-----------------------------------------------------------------------
												dword				sizeof ( vertex ) * yellowBeeVertexCount  ; ByteWidth
												dword				D3D11_USAGE_DYNAMIC								; Usage
												dword				D3D11_BIND_VERTEX_BUFFER						; BindFlags
												dword				D3D11_CPU_ACCESS_WRITE							; CPUAccessFlags
												dword				0												; MiscFlags
