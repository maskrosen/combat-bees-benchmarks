...
set rc_directory="C:\Program Files (x86)\Windows Kits\10\bin\10.0.22621.0\x86

rem Set this value to the location of ml64.exe under the VC directory
set ml_directory="C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.37.32822\bin\Hostx64\x64

rem Set this value to the location of link.exe under the VC directory
set link_directory="C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.37.32822\bin\Hostx64\x64
...
%link_directory%\link.exe" DXSample.obj largeArrays.obj font_nasm.obj resource.res /debug:full /opt:ref /opt:noicf /def:DXSample.def /entry:Startup /machine:x64 /map /out:DXSample.exe /PDB:DXSample.pdb /subsystem:windows,6.0^
 ...
 "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.37.32822\lib\x64\msvcrt.lib"^
 "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.37.32822\lib\x64\libvcruntime.lib"^
 ...
 "C:\Program Files (x86)\Windows Kits\10\Lib\10.0.22621.0\um\x64\d3d11.lib"^
